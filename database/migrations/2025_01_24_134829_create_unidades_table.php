...
class CreateUnidadesTable extends Migration
{
    ...
    public function down()
    {
        ...
        Schema::table('produtos', function (Blueprint $table) {
            $table->dropForeign('produtos_unidade_id_foreign'); //convenção: nome da tabela + nome da coluna + _foreign
            $table->dropColumn('unidade_id');
        });

        // Remover o relacionamento com a tabela produtos_detalhes
        Schema::table('produto_detalhes', function (Blueprint $table) {
            $table->dropForeign('produto_detalhes_unidade_id_foreign'); //convenção: nome da tabela + nome da coluna + _foreign
            $table->dropColumn('unidade_id');
        });
